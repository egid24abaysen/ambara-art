...
function Slider({ defaultValue, startingValue, maxValue, isStepped, stepSize, leftIcon, rightIcon, onChange, showValue }) {
  ...
  return (
    <>
        ...
        >
          <motion.div
            style={{
              ...
              height: useTransform(scale, [1, 1.2], [5, 10]),
              marginTop: useTransform(scale, [1, 1.2], [0, -2.5]),
              marginBottom: useTransform(scale, [1, 1.2], [0, -2.5]),
            }}
      ...
      {showValue && (
        <p className="slider-value-indicator">{Math.round(value)}°</p>
      )}
    </>
  );
}
